            ...
            <div class="offcanvas offcanvas-end bg-purple" id="offcanvasNavbar">
                ...
                <div class="offcanvas-body pt-0 px-4">
                    ...
                    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                        <li class="nav-item col-6 col-md-auto"><a href="#" class="nav-link active"><i class="bi-github"></i><small class="ms-2d-md-none">Github</small> </a> </li>
                        ...
                        <div class="dropdown" data-bs-theme="light">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><button class="dropdown-item activebg-purple" type="button"><small>Latest (5.3.x) <iclass="bi-check"></i></small></button></li>
...
<?php /**PATH E:\M. RAYHAN LABIB AFIFI IS-05-02\Semester 4\Pemrograman Framework\basic-routing\resources\views/clone.blade.php ENDPATH**/ ?>